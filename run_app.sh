...
# Check if main virtual environment exists
if [ ! -d "main-env" ]; then
    echo "❌ Main virtual environment not found. Please run setup first:"
    echo "   uv venv main-env --python 3.12 --seed"
    echo "   source main-env/bin/activate"
